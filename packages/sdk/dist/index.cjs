...
__export(index_exports, {
  GrabberCore: () => GrabberDevTools,
  GrabberDevTools: () => GrabberDevTools2,
  checkFluentValue: () => checkFluentValue,
  checkVSCodeConnection: () => checkVSCodeConnection,
  extractComputedStyles: () => extractComputedStyles,
  extractStyleData: () => extractStyleData,
  fiberDataToComponentInfo: () => fiberDataToComponentInfo,
  formatBagForCopilot: () => formatBagForCopilot,
  getFiberData: () => getFiberData,
  getFiberDataWithRetry: () => getFiberDataWithRetry,
  getFiberFromElement: () => getFiberFromElement,
  getFluentUITokens: () => getFluentUITokens,
  getGriffelData: () => getGriffelData,
